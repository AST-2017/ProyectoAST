/**
 * ComprobarClienteRegistrado.java
 *
...
/**
 *  ComprobarClienteRegistrado bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ComprobarClienteRegistrado implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://Orquestador",
            "comprobarClienteRegistrado", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":comprobarClienteRegistrado", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "comprobarClienteRegistrado", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ComprobarClienteRegistrado parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ComprobarClienteRegistrado object = new ComprobarClienteRegistrado();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"comprobarClienteRegistrado".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ComprobarClienteRegistrado) orquestador.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
