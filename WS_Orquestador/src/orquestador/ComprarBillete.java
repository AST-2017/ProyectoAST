...
/**
 *  ComprarBillete bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ComprarBillete implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":comprarBillete", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "comprarBillete", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ComprarBillete parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ComprarBillete object = new ComprarBillete();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"comprarBillete".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ComprarBillete) orquestador.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://Orquestador",
                            "id_oferta").equals(reader.getName())) ||
                        new javax.xml.namespace.QName("", "id_oferta").equals(
                            reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "id_oferta" + "  cannot be null");
                    }
