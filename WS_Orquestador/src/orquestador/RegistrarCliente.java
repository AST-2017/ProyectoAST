...
/**
 *  RegistrarCliente bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RegistrarCliente implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://Orquestador",
            "registrarCliente", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":registrarCliente", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "registrarCliente", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RegistrarCliente parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RegistrarCliente object = new RegistrarCliente();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"registrarCliente".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RegistrarCliente) orquestador.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://Orquestador",
                            "apellido1").equals(reader.getName())) ||
                        new javax.xml.namespace.QName("", "apellido1").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setApellido1(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
                        reader.getElementText(); // throw away text nodes if any.
                    }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://Orquestador",
                            "apellido2").equals(reader.getName())) ||
                        new javax.xml.namespace.QName("", "apellido2").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setApellido2(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
                        reader.getElementText(); // throw away text nodes if any.
                    }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "telefono").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
