...
/**
 *  PagarResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class PagarResponse implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":pagarResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "pagarResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static PagarResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PagarResponse object = new PagarResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"pagarResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (PagarResponse) org.apache.ws.axis2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
